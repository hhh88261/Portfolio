...
### 기술 스택
<img src="https://img.shields.io/badge/vue.js-41B883?style=for-the-badge&logo=vue.js&logoColor=white"> : 수백개의 개의 마커가 웹상에 표시되야 했기에 렌더링이 빠른 vue를 선택했습니다  
...
- 신호생성 서버, 디코딩 서버, 클라이언트 간 데이터 전달을 위해 소켓을 사용했습니다. 데이터는 동기방식으로 전송되도록 구현했습니다.
프로젝트의 규모가 크지 않고 고성능의 리소스 처리가 필요하지 않았기 때문에, 신뢰성있고 직관적인 데이터 흐름을 확인할 수 있는 동기방식을 사용하는 것이 적합할 것이라 판단했습니다.
